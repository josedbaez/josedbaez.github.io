...
*IMPORTANT: Redirects URIs should be set to http://YOURSITE/signin-facebook and http://YOURSITE/signin-google respectively. These urls are automatically generated by the middlewares being used here.*
...
<img class="" src="/images/broken-link-list.png" alt="Login List">
---
